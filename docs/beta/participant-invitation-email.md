...
[Full installation guide](../docs/beta/beta-onboarding.md)
...
- [Onboarding Guide](../docs/beta/beta-onboarding.md) - Full setup walkthrough
- [FAQ](../docs/beta/beta-faq.md) - Common questions
- [Troubleshooting](../docs/beta/beta-onboarding.md#troubleshooting) - Fix issues

...
8. **`docs/ops/performance/sla.md`** (11KB, 544 lines)
...
3. **Review and adjust SLA targets** in `docs/ops/performance/sla.md` based on baseline
...
| `docs/ops/performance/sla.md` | 544 | SLA definitions |

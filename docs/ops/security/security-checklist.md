...
- [x] Security policy (`docs/ops/security/SECURITY.md`)
- [x] Threat model (`docs/ops/security/threat-model.md`)
- [x] Security checklist (`docs/ops/security/security-checklist.md`) (this document)
- [x] Security review report (`docs/ops/security/SECURITY_REVIEW.md`)
- [x] Signing policy (`docs/ops/security/SIGNING_POLICY.md`)
- [x] Penetration testing guide (`docs/ops/security/penetration-testing-guide.md`) (pending)
- [x] Security implementation summary (`docs/ops/security/IMPLEMENTATION_SUMMARY.md`)

...
## Tracking (per phase; label with FR; status updated continuously)
- Phase 1 (Data model & migration)
  - [x] Extend Deployment with lineage/upstream/sync metadata (FR-1/10/16)
  - [x] Migration script to backfill deployment lineage/sync status (FR-1/10/16)
...
- Phase 3 (Sync service)
  ...
  - [ ] Directional sync flows upstream↔collection↔project w/ dry-run (FR-2/7/8) — collection→project path implemented; upstream and project→collection pending (reasoning-heavy)
- Phase 4 (CLI/API/UX)

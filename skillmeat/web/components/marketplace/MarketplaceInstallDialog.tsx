    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {strategy === 'fork' && 'Conflicts will be resolved by creating renamed copies.'}
              {strategy === 'skip' && 'Existing artifacts will be left unchanged.'}
            </p>
          </div>

          {/* Trust Warning */}
          <div className="flex gap-2 rounded-lg border border-yellow-200 bg-yellow-50 p-3 dark:border-yellow-800 dark:bg-yellow-950/20">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-yellow-800 dark:text-yellow-200">
                This bundle is signed and verified. However, always review artifacts before use as
                they may access system resources.
              </p>
            </div>
          </div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleConfirm} disabled={isInstalling}>
            {isInstalling ? (
              <>

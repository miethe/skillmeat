...
describe("ConflictResolver", () => {
  ...
  it("shows resolution summary when resolution is selected", () => {
    ...
    expect(
      screen.getByText(/Will use Collection version of this file/)
    ).toBeInTheDocument();
  });
  ...
  it("shows correct summary for ours resolution", () => {
    ...
    expect(
      screen.getByText(/Will keep Project version of this file/)
    ).toBeInTheDocument();
  });
  ...
  it("shows correct summary for manual resolution", () => {
    ...
    expect(
      screen.getByText(/Will manually merge both versions/)
    ).toBeInTheDocument();
  });

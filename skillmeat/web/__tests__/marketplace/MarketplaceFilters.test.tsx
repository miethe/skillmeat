...
describe('MarketplaceFilters', () => {
  it('renders search input', () => {
    ...
    expect(screen.getByPlaceholderText('Search marketplace listings...')).toBeInTheDocument();
  });
  ...
  it('displays enabled brokers only', () => {
    const handleChange = jest.fn();
    render(
      <MarketplaceFilters filters={{}} onFiltersChange={handleChange} brokers={mockBrokers} />
    );

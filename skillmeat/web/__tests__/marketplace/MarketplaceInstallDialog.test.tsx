...
describe('MarketplaceInstallDialog', () => {
  ...
  it('displays trust warning', () => {
    ...
    expect(screen.getByText(/This bundle is signed and verified/i)).toBeInTheDocument();
  });
  ...
  it('allows selecting skip strategy', () => {
    ...
    expect(screen.getByText('Existing artifacts will be left unchanged.')).toBeInTheDocument();
  });

...
export type DetectedArtifact = {
  ...
  status?: string | null;
  /**
   * Artifact title from frontmatter for search display
   */
  title?: string | null;
  /**
   * Artifact description from frontmatter for search
   */
  frontmatter_description?: string | null;
  /**
   * Tags from frontmatter for search filtering
   */
  search_tags?: Array<string> | null;
  /**
   * Concatenated searchable text (title + description + tags)
   */

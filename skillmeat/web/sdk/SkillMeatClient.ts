...
import { ContextModulesService } from './services/ContextModulesService';
import { ContextPacksService } from './services/ContextPacksService';
...
import { MemoryItemsService } from './services/MemoryItemsService';
...
export class SkillMeatClient {
  ...
  public readonly contextModules: ContextModulesService;
  public readonly contextPacks: ContextPacksService;
  ...
  public readonly marketplaceCatalog: MarketplaceCatalogService;
  ...
  public readonly memoryItems: MemoryItemsService;
  ...
  constructor(
    ...
    this.contextModules = new ContextModulesService(this.request);
    this.contextPacks = new ContextPacksService(this.request);
    ...
    this.marketplaceCatalog = new MarketplaceCatalogService(this.request);
    ...
    this.memoryItems = new MemoryItemsService(this.request);

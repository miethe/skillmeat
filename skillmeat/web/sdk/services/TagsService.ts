...
export class TagsService {
   ...
   * @throws ApiError
   */
  public getTagApiV1TagsTagIdGet({ tagId }: { tagId: string }): CancelablePromise<TagResponse> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public deleteTagApiV1TagsTagIdDelete({ tagId }: { tagId: string }): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/api/v1/tags/{tag_id}',
      path: {

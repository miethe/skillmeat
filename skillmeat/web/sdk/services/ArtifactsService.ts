...
import type { ArtifactTagsUpdate } from '../models/ArtifactTagsUpdate';
...
import type { CreateLinkedArtifactRequest } from '../models/CreateLinkedArtifactRequest';
...
import type { LinkedArtifactReferenceSchema } from '../models/LinkedArtifactReferenceSchema';
...
export class ArtifactsService {
  ...
  public listArtifactsApiV1ArtifactsGet({
    ...
    tags?: string | null;
    /**
     * Filter by tools (comma-separated). Returns artifacts that use any of the specified tools.
     */
    tools?: string | null;
    /**
    ...
    /**
     * Filter for artifacts with unlinked references (true) or without (false)
     */
    hasUnlinked?: boolean | null;
    /**
     * Filter by marketplace import batch ID
     */
   ...
   * Deploy artifact from collection to project's .claude/ directory. Supports 'overwrite' (default) and 'merge' strategies.
  ...
  /**
   * Get source-to-project diff
   * Compare artifact upstream source directly against project deployment
   * @returns ArtifactDiffResponse Successfully retrieved source-project diff
   * @throws ApiError
   */
  public getArtifactSourceProjectDiffApiV1ArtifactsArtifactIdSourceProjectDiffGet({
    artifactId,
    projectPath,
    collection,
  }: {
    artifactId: string;
    /**
     * Path to project deployment directory
     */
    projectPath: string;
    /**
     * Collection name (searches all if not specified)
    ...
    return this.httpRequest.request({
      method: 'GET',
      url: '/api/v1/artifacts/{artifact_id}/source-project-diff',
      path: {
        artifact_id: artifactId,
      },
      query: {
      ...
      errors: {
        400: `Invalid request or missing project_path`,
        401: `Unauthorized`,
        404: `Artifact not found`,
        422: `Validation Error`,
        500: `Internal server error`,
   ...
   * @returns ArtifactResponse Successfully updated artifact tags
   * @throws ApiError
   */
  public updateArtifactTagsApiV1ArtifactsArtifactIdTagsPut({
    artifactId,
    requestBody,
    collection,
  }: {
    artifactId: string;
    requestBody: ArtifactTagsUpdate;
    /**
     * Collection name (uses default if not specified)
     */
    collection?: string | null;
   ...
   * Create a link from this artifact to another artifact.
   * @returns LinkedArtifactReferenceSchema Successfully created artifact link
   * @throws ApiError
   */
  public createLinkedArtifactApiV1ArtifactsArtifactIdLinkedArtifactsPost({
    artifactId,
    requestBody,
    collection,
  }: {
    artifactId: string;
    requestBody: CreateLinkedArtifactRequest;
    /**
     * Collection name (uses default if not specified)
     */
    collection?: string | null;
  }): CancelablePromise<LinkedArtifactReferenceSchema> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/api/v1/artifacts/{artifact_id}/linked-artifacts',
      path: {
        artifact_id: artifactId,
      },
      query: {
      ...
      mediaType: 'application/json',
      errors: {
        400: `Invalid request or self-linking`,
        401: `Unauthorized`,
        404: `Artifact not found`,
   ...
   * @returns LinkedArtifactReferenceSchema Successfully retrieved artifact links
   * @throws ApiError
   */
  public listLinkedArtifactsApiV1ArtifactsArtifactIdLinkedArtifactsGet({
    artifactId,
    linkType,
    collection,
  }: {
    artifactId: string;
    /**
     * Filter by link type (requires, enables, related)
     */
     ...
     */
    collection?: string | null;
  }): CancelablePromise<Array<LinkedArtifactReferenceSchema>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/api/v1/artifacts/{artifact_id}/linked-artifacts',
      path: {
   ...
   * Remove a link from this artifact to another.
   * @returns void
   * @throws ApiError
   */
  public deleteLinkedArtifactApiV1ArtifactsArtifactIdLinkedArtifactsTargetArtifactIdDelete({
    artifactId,
    targetArtifactId,
    collection,
  }: {
    ...
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/api/v1/artifacts/{artifact_id}/linked-artifacts/{target_artifact_id}',
      path: {
        artifact_id: artifactId,
      ...
      errors: {
        401: `Unauthorized`,
        404: `Artifact or link not found`,
        422: `Validation Error`,
        500: `Internal server error`,
      },
    });
   ...
   * Get references that couldn't be auto-linked.
   * @returns string Successfully retrieved unlinked references
   * @throws ApiError
   */
  public getUnlinkedReferencesApiV1ArtifactsArtifactIdUnlinkedReferencesGet({
    artifactId,
    collection,
  }: {
    artifactId: string;
    ...
    return this.httpRequest.request({
      method: 'GET',
      url: '/api/v1/artifacts/{artifact_id}/unlinked-references',
      path: {
        artifact_id: artifactId,
      },
      query: {

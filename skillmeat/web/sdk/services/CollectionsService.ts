...
import type { skillmeat__api__schemas__collections__CollectionArtifactsResponse } from '../models/skillmeat__api__schemas__collections__CollectionArtifactsResponse';
...
export class CollectionsService {
   ...
   * Retrieve a paginated list of artifacts within a specific collection. NOTE: This endpoint uses legacy file-based collections and does NOT include collection membership information. Use /user-collections/{id}/artifacts instead for full database-backed functionality.
   * @returns skillmeat__api__schemas__collections__CollectionArtifactsResponse Successfully retrieved artifacts
   * @throws ApiError
   */
  ...
  }): CancelablePromise<skillmeat__api__schemas__collections__CollectionArtifactsResponse> {
    return this.httpRequest.request({
      method: 'GET',

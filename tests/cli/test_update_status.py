...
class TestStatusCommand:
    ...
    def test_status_shows_available_updates(
        self, mock_check_updates, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.check_updates")
    def test_status_all_up_to_date(
        self, mock_check_updates, isolated_cli_runner, sample_skill_dir
    ):
    ...
    def test_status_deployment_check(
        self, mock_check_status, isolated_cli_runner, sample_skill_dir, temp_project
    ):
    ...
    @patch("skillmeat.core.deployment.DeploymentManager.check_deployment_status")
    def test_status_shows_modified_deployments(
        self, mock_check_status, isolated_cli_runner, sample_skill_dir, temp_project
    ):
...
class TestUpdateCommand:
    ...
    def test_update_single_artifact(
        self, mock_update, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.update")
    def test_update_with_strategy_upstream(
        self, mock_update, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.update")
    def test_update_with_strategy_local(
        self, mock_update, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.update")
    def test_update_with_strategy_prompt(
        self, mock_update, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.update")
    def test_update_from_specific_collection(
        self, mock_update, isolated_cli_runner, sample_skill_dir
    ):
...
class TestStatusUpdateWorkflow:
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.check_updates")
    @patch("skillmeat.core.artifact.ArtifactManager.update")
    def test_check_then_update_workflow(
        self, mock_update, mock_check_updates, isolated_cli_runner, sample_skill_dir
    ):
    ...
    @patch("skillmeat.core.artifact.ArtifactManager.check_updates")
    def test_status_multiple_artifacts(
        self,
        mock_check_updates,
        isolated_cli_runner,
        sample_skill_dir,

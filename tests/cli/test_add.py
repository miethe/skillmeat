...
class TestAddSkillCommand:
    ...
    def test_add_skill_security_warning(self, isolated_cli_runner, sample_skill_dir):
        ...
        result = runner.invoke(
            main, ["add", "skill", str(sample_skill_dir)], input="n\n"
        )
    ...
    def test_add_skill_security_warning_accepted(
        ...
        result = runner.invoke(
            main, ["add", "skill", str(sample_skill_dir)], input="y\n"
        )
    ...
    def test_add_skill_from_github(
    ...
    def test_add_skill_to_custom_collection(
        self, isolated_cli_runner, sample_skill_dir
    ):
...
class TestAddCommandCommand:
    ...
    def test_add_command_from_local_path(
        self, isolated_cli_runner, sample_command_file
    ):
    ...
    def test_add_command_with_custom_name(
        self, isolated_cli_runner, sample_command_file
    ):
    ...
    @patch("skillmeat.sources.github.GitHubSource.fetch")
    def test_add_command_from_github(
        self, mock_fetch, isolated_cli_runner, sample_command_file, tmp_path
    ):
...
class TestAddAgentCommand:
    ...
    @patch("skillmeat.sources.github.GitHubSource.fetch")
    def test_add_agent_from_github(
        self, mock_fetch, isolated_cli_runner, sample_agent_file, tmp_path
    ):
...
class TestAddCommandEdgeCases:
    ...
    def test_add_multiple_artifacts_same_session(
    ...
    def test_add_all_artifact_types(
        self,
        isolated_cli_runner,
        sample_skill_dir,
        sample_command_file,

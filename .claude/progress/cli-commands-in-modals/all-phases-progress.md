...
tasks:
  TASK-1.1:
    ...
    description: 'Build utility functions to generate CLI commands with various options.
      ...
      - generateDeployWithProjectCommand(artifactName: string, projectPath = ''.''):
      string
  ...
  TASK-1.2:
    ...
    description: 'Custom React hook for managing clipboard copy state and operations.
      ...
      - Pattern from ShareLink component (components/sharing/share-link.tsx lines
      30-38)
  ...
  TASK-3.1:
    ...
    - TASK-1.1
    - TASK-1.2
    description: 'Build reusable component to display CLI commands with copy functionality.

...
success_criteria:
- id: SC-1
  description: Clerk SDK integrated and ClerkProvider wraps app
  status: pending
- id: SC-2
  description: Login and signup pages functional
  status: pending
- id: SC-3
  description: Workspace switcher changes org context
  status: pending
- id: SC-4
  description: Auth token injected into all API calls
  status: pending
- id: SC-5
  description: Protected routes redirect unauthenticated users
  status: pending
- id: SC-6
  description: Zero-auth local mode works without Clerk
  status: pending
files_modified:

...
tasks:
  # Phase 1: Database & API Foundation (15 pts)
  - id: "1.1"
  ...
  # Phase 2: Shared Components & Hooks (14 pts)
  - id: "2.1"
  ...
  # Phase 3: Deployment Set Integration (5 pts)
  - id: "3.1"
  ...
  - id: "3.3"
    ...
    status: "pending"
    assigned_to: ["ui-engineer-enhanced"]
    dependencies: ["3.1", "3.2", "1.7"]

  # Phase 4: Settings UI (7 pts)
  - id: "4.1"
  ...
  # Phase 5: Validation & Polish (6 pts)
  - id: "5.1"
...
parallelization:
  batch_1: ["1.1", "2.1", "2.2", "2.3", "4.1"]
  batch_2: ["1.2", "2.4"]
  batch_3: ["1.3", "2.5", "2.6"]
  batch_4: ["1.4", "2.7"]
  batch_5: ["1.5", "1.6"]
  batch_6: ["1.7", "3.1", "3.2", "4.2", "4.3"]
  batch_7: ["3.3", "4.4", "5.1", "5.3"]
  batch_8: ["5.2", "5.4", "5.5"]
---

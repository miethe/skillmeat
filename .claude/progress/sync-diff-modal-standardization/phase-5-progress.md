...
success_criteria:
- id: SC-1
  description: 80%+ coverage for new/modified code
  status: pending
- id: SC-2
  description: All tests pass (pnpm test)
  status: pending
- id: SC-3
  description: CLAUDE.md updated with modal patterns
  status: pending
- id: SC-4
  description: API endpoint mapping includes sync/diff endpoints
  status: pending
files_modified:

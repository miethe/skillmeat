...
parallelization:
  ...
  batch_3: ["TASK-1.4"]
  critical_path: ["TASK-1.1", "TASK-1.2", "TASK-1.4"]
  estimated_total_time: "5 pts"

blockers: []

success_criteria:
  - { id: "SC-1", description: "Zero 400 errors on /manage for any artifact type", status: "pending" }
  - { id: "SC-2", description: "GitHub artifacts with tracking show upstream diff", status: "pending" }
  - { id: "SC-3", description: "Marketplace/local artifacts show no upstream state", status: "pending" }
  - { id: "SC-4", description: "No TanStack Query retry loops", status: "pending" }

...
tasks:
- id: EXT-201
  description: "Utility extraction \u2014 move generic utility functions (formatting,\
    \ parsing, tree helpers) into the package with no SkillMeat-specific imports"
  status: completed
  story_points: 2
  ...
  - PKG-103
- id: EXT-202
  description: "FileTree extraction \u2014 extract the FileTree component and all\
    \ sub-components into the package; ensure it compiles and is tested independently"
  status: completed
  story_points: 3
  ...
  - EXT-201
- id: EXT-203
  description: "FrontmatterDisplay extraction \u2014 extract the FrontmatterDisplay\
    \ component into the package with no SkillMeat-specific imports"
  status: completed
  story_points: 1
  assigned_to: ui-engineer-enhanced
  dependencies:
  - EXT-201
- id: EXT-204
  description: "Shared type exports \u2014 consolidate and export all shared TypeScript\
    \ types/interfaces used across the extracted components through the public API"
  status: completed
  story_points: 1
  assigned_to: frontend-developer
  dependencies:

...
parallelization:
  batch_1: ["P2-T1", "P2-T2", "P2-T3", "P2-T4"]
  batch_2: ["P2-T5"]
  critical_path: ["P2-T1", "P2-T5"]
  estimated_total_time: "4-5h"

blockers: []

success_criteria:
  - { id: "SC-1", description: "File serving endpoint returns 200 for embedded artifact file requests", status: "pending" }
  - { id: "SC-2", description: "Frontend SDK generates correct URLs for file-path artifacts", status: "pending" }
  - { id: "SC-3", description: "Source detail page renders embedded artifacts as children", status: "pending" }
  - { id: "SC-4", description: "All new unit and integration tests pass", status: "pending" }
  - { id: "SC-5", description: "pnpm type-check passes", status: "pending" }

...
tasks:
  - id: CUX-P3-01
    description: "Wire CompositePreview into marketplace import dialog; conditionally render for composite sources"
    status: pending
    assigned_to:
      - ui-engineer-enhanced
    dependencies:
  ...
  - id: CUX-P3-02
    description: "Wire CompositePreview into collection add flow; conditional on source type"
    status: pending
    assigned_to:
      - frontend-developer
    dependencies:
  ...
  - id: CUX-P3-03
    description: "Wire ConflictResolutionDialog to trigger on hash mismatch during import; connect to backend API"
    status: pending
    assigned_to:
      - frontend-developer
    dependencies:
  ...
  - id: CUX-P3-04
    description: "Create useImportComposite and useMutateComposite mutation hooks with optimistic updates and rollback"
    status: pending
    assigned_to:
      - frontend-developer
    dependencies:
  ...
  - id: CUX-P3-05
    description: "Verify import calls correct backend endpoint for atomic composite + children transaction"
    status: pending
    assigned_to:
      - python-backend-engineer
    dependencies:
  ...
  - id: CUX-P3-06
    description: "Playwright E2E test for marketplace plugin import flow: filter -> view -> preview -> confirm -> collection updated"
    status: pending
    assigned_to:
      - ui-engineer-enhanced
    dependencies:
  ...
  - id: CUX-P3-07
    description: "Playwright E2E test for conflict resolution during import: detect -> dialog -> resolve -> import succeeds"
    status: pending
    assigned_to:
      - frontend-developer
    dependencies:

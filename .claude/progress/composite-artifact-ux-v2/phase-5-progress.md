...
tasks:
- id: CUX-P5-01
  description: Update skillmeat list command to include composite artifacts; correctly
    labeled; filtering by type works
  status: completed
  assigned_to:
  - python-backend-engineer
  dependencies:
  ...
  priority: high
- id: CUX-P5-02
  description: Implement skillmeat composite create Click command to create plugin
    from specified artifact sources
  status: completed
  assigned_to:
  - python-backend-engineer
  dependencies:

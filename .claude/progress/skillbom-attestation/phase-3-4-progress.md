...
tasks:
  ...
  - id: "TASK-3.2"
    ...
    estimate: "3 pts"
  - id: "TASK-3.3"
    name: "Implement EnterpriseArtifactHistoryRepository (SQLAlchemy 2.x, PostgreSQL) with multi-tenant filtering"
    status: "pending"
  ...
  - id: "TASK-3.4"
    ...
    estimate: "3 pts"
  - id: "TASK-3.5"
    name: "Register SQLAlchemy event listeners (after_insert/update/delete) on Artifact model to trigger history capture"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
    dependencies: ["TASK-3.4"]
    estimate: "3 pts"
  - id: "TASK-4.1"
    name: "Create AttestationScopeResolver with owner-type filtering logic (user/team/enterprise/admin visibility rules)"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
    dependencies: []
    estimate: "2 pts"
  - id: "TASK-4.2"
    name: "Populate AttestationRecord with owner_type/owner_id/roles/scopes from AuthContext on BOM creation"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
  ...
  - id: "TASK-4.3"
    ...
    estimate: "2 pts"
  - id: "TASK-4.4"
    name: "Implement enterprise AttestationPolicy enforcement (validate_required_artifacts, extract_compliance_metadata)"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
    dependencies: ["TASK-4.1", "TASK-4.2"]
    estimate: "2 pts"
  - id: "TASK-4.5"
    name: "Write RBAC unit tests verifying cross-user/cross-team/cross-tenant visibility isolation"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
...
parallelization:
  ...
  batch_2: ["TASK-3.3", "TASK-3.4", "TASK-3.5"]
  batch_3: ["TASK-4.1", "TASK-4.2", "TASK-4.3"]
  batch_4: ["TASK-4.4", "TASK-4.5"]
---

...
tasks:
  ...
  - id: "TASK-2.5"
    ...
    estimate: "2 pts"
  - id: "TASK-2.6"
    name: "Implement Memory item and Deployment set adapters, BomSerializer, Pydantic schemas, integration test, and performance benchmarks"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
...
parallelization:
  ...
  batch_2: ["TASK-1.5", "TASK-1.6"]
  batch_3: ["TASK-2.1", "TASK-2.2", "TASK-2.3", "TASK-2.4", "TASK-2.5"]
  batch_4: ["TASK-2.6"]
---

...
blockers:
  - id: "BLOCKER-P2-001"
    ...
    severity: "high"
    blocking: ["TASK-2.2", "TASK-2.3"]
    resolution: "Phase 1 completion (TASK-1.4)"
    created: "2026-03-03"

success_criteria:
  - { id: "SC-1", description: "skillmeat:context:inject action writes .claude/ files into Backstage workspace", status: "pending" }
  - { id: "SC-2", description: "skillmeat:deployment:register action creates DeploymentSet via SAM API", status: "pending" }
  - { id: "SC-3", description: "Plugin README includes input schemas and configuration examples", status: "pending" }

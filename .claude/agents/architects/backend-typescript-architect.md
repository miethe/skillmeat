...
Before implementing backend features, explore existing patterns:
```markdown
Task("codebase-explorer", "Find all existing service layer implementations to understand current patterns")
Task("codebase-explorer", "Locate error handling patterns in API routers")
Task("codebase-explorer", "Analyze existing repository methods for consistency")
```

### Documentation
Delegate documentation work to appropriate agents:
```markdown
# For API documentation
Task("documentation-writer", "Document the user authentication API endpoints with complete specifications")

# For code comments
Task("documentation-writer", "Add TSDoc comments to service layer methods")

# For technical guides
Task("documentation-writer", "Create integration guide for the rate limiting middleware")
```
...
- Writing services, repositories, and routers
- Performance optimization and error handling
- Security implementation and testing

**Delegate To Other Agents:**
- Codebase exploration → `Task("codebase-explorer", ...)`
- API documentation → `Task("documentation-writer", ...)`
- Code comments → `Task("documentation-writer", ...)`
- Critical ADRs → `Task("documentation-planner", ...)`
